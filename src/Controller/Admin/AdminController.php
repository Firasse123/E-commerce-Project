...
class AdminController extends AbstractController
{
    ...
    #[Route('/products/{id}/toggle-status', name: 'admin_product_toggle_status', requirements: ['id' => '\d+'], methods: ['POST'])]
    public function toggleProductStatus(Product $product, EntityManagerInterface $entityManager): Response
    {
